<?php
	...
	$getFromU->delete('comments', array('user_id' => '1'));	
			...
			<div class="info-inner">
				...
				<div class="info-in-body">
					...
					<div class="info-body-name">
						<div class="in-b-name">
							<div><a href="<?php echo BASE_URL.$user->user_name; ?>"> <?php echo $user->screenName ?> </a></div>
 	...
 	<!--==TRENDS==-->
		...
		<div class="in-center">
			<div class="in-center-wrap">
						 ...
						 <div class="tweet-footer">
						 	<div class="t-fo-left">
						 		<ul>
						 			...
						 			<span class="tweet-error"> <?php if(isset($error)){echo $error;}
						 			else if(isset($imageError)){echo $imageError;} ?> </span>
						 			</li>
						 		</ul>
						 	</div>
				...
				<script type="text/javascript" src="assets/js/postMessages.js"></script>
