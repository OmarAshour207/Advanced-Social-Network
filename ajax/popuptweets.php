					...
					<div class="tweet-show-popup-head">
						<div class="tweet-show-popup-head-left">
							...
							<div class="tweet-show-popup-name">
								<div class="t-s-p-n">
									<a href="<?php echo BASE_URL.$tweet->user_name; ?>">
					...
					<div class="tweet-show-popup-footer-wrap">
						...
						<div class="tweet-show-popup-footer-menu">
							<ul>
								...
								<li><button type="button"><i class="fa fa-retweet" aria-hidden="true"></i><span class="retweetsCount"><?php echo $tweet->retweetCount; ?></span></button></li>
			 	...
			 	<div class="tweet-show-popup-footer-input-wrap">
					<div class="tweet-show-popup-footer-input-inner">
						...
						<div class="tweet-show-popup-footer-input-right">
							<input id="commentField" type="text" data-tweet="<?php echo $tweet->tweetID; ?>" name="comment"  placeholder="Reply to @<?php echo $user->user_name; ?>">
						</div>
					</div>
					<div class="tweet-footer">
					 	...
					 	<div class="t-fo-right">
			 		 		...
			 		 		<script type="text/javascript" src="<?php echo BASE_URL;?>assests/js/follow.js"></script>
					 	</div>
					 </div>
											...
											<div class="tweet-show-popup-comment-head-right">
												  <div class="tweet-show-popup-comment-name-box">
												 	<div class="tweet-show-popup-comment-name-box-name"> 
												 		<a href="'.BASE_URL.$comment->user_name.'">'.$comment->screenName.'</a>
												 	</div>
												 	<div class="tweet-show-popup-comment-name-box-tname">
												 		<a href="'.BASE_URL.$comment->user_name.'">@'.$comment->user_name.' - '.$comment->commentAt.'</a>
												 	</div>
												 </div> 
												 <div class="tweet-show-popup-comment-right-tweet">
												 		<p><a href="'.BASE_URL.$tweet->user_name.'">@'.$tweet->user_name.'</a> '.$comment->comment.'</p>
												 </div>
											 	<div class="tweet-show-popup-footer-menu">
													<ul>
