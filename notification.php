<?php
	...
	// $getFromU->create('users', array('user_name' => 'aizaz.diano' , 'email' => 'dania@gmail.com' , 'password' => md5('password')));
			...
			<ul>
				...
				<div class="drop-wrap">
					<div class="drop-inner">
						<ul>
							<li><a href="<?php echo BASE_URL.$user->username; ?>"> </a></li>
			...
			<div class="info-inner">
				...
				<div class="info-in-body">
					...
					<div class="info-body-name">
						<div class="in-b-name">
							<div><a href="<?php echo BASE_URL.$user->screenName; ?>"> <?php echo $user->screenName ?> </a></div>
							<span><small><a href="<?php echo BASE_URL.$user->user_name; ?>"> <?php echo '@' . $user->user_name ?> </a></small></span>
						</div><!-- in b name end-->
			...
			<div class="notification-wrapper">
				<div class="notification-inner">
					<div class="notification-header">
						...
						<a href="<?php echo BASE_URL.$data->user_name; ?>" class="notifi-name"><?php echo $data->screenName; ?></a><span> Followed you - <span><?php echo $getFromU->timeAgo($data->time); ?></span>
		...
		<?php if($data->type == 'like') :?>
			<div class="notification-wrapper">
				<div class="notification-inner">
					...
					<div class="notification-tweet"> 
						<a href="<?php echo BASE_URL.$data->user_name; ?>" class="notifi-name"><?php echo $data->screenName; ?></a><span> liked your <?php if($data->tweetBy == $user_id){echo 'Tweet';}else {echo 'Retweet';} ?> - <span><?php echo $getFromU->timeAgo($data->time); ?></span>
					</div>
					<div class="notification-footer">
						<div class="noti-footer-inner">
							<div class="noti-footer-inner-left">
								<div class="t-h-c-name">
									<span><a href="<?php echo BASE_URL.$user->user_name; ?>"><?php echo $user->screenName; ?></a></span>
		...
		<?php if($data->type == 'retweet') :?>
			...
			<div class="notification-wrapper">
				<div class="notification-inner">
					...
					<div class="notification-tweet"> 
						<a href="<?php echo BASE_URL.$data->user_name; ?>" class="notifi-name"><?php echo $data->screenName; ?></a><span> retweet your <?php if($data->tweetBy == $user_id){echo 'Tweet';}else {echo 'Retweet';} ?> - <span><?php echo $getFromU->timeAgo($data->time); ?></span>
					</div>
					<div class="notification-footer">
						<div class="noti-footer-inner">
