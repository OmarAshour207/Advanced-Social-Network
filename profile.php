...
<html>
	<head>
		<title><?php echo $profileData->screenName.'(@'.$profileData->user_name.')'; ?></title>
		<meta charset="UTF-8" />
...
<div class="profile-nav">
 <div class="profile-navigation">
	<ul>
		...
		<li>
			<a href="<?php echo BASE_URL.$profileData->user_name; ?>">
				<div class="n-head">
					<a href="<?php echo BASE_URL.$profileData->user_name; ?>/following">FOLLOWING</a>
				</div>
				<div class="n-bottom">
		...
		<li>
		 <a href="<?php echo BASE_URL.$profileData->user_name ?>/followers">
				<div class="n-head">
					FOLLOWERS
				</div>
				<div class="n-bottom">
	 ...
	 <!-- PROFILE-IMAGE -->
		...
		<div class="profile-name-wrap">
			...
			<div class="profile-tname">
				@<span class="username"><?php echo $profileData->user_name ?></span>
			</div>
		</div>
