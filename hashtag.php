	...
	<div class="follow-unfollow-inner">
		...
		<div class="follow-person-button-img">
			...
			<div class="follow-person-button">
			   <?php $getFromF->followBtn($users->user_id, $user_id, $user_id); ?>
			</div>
		</div>
		<div class="follow-person-bio">
			<div class="follow-person-name">
				<a href="<?php echo BASE_URL.$users->user_name; ?>"><?php echo $users->screenName; ?></a>
			</div>
			<div class="follow-person-tname">
				<a href="<?php echo BASE_URL.$users->user_name; ?>">@<?php echo $users->user_name; ?></a>
			</div>
