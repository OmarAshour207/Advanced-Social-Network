$(function(){
	$(document).on('click','.like-btn', function(){
		...
		$.post('http://localhost/Social_Network_Twitter/ajax/like.php', {like:tweet_id, user_id:user_id}, function(){
			counter.show();
		...
		$.post('http://localhost/Social_Network_Twitter/ajax/like.php', {unlike:tweet_id, user_id:user_id}, function(){
			counter.show();
