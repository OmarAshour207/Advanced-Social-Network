$(function(){
	$('.follow-btn').click(function(){
		...
		{
			$.post('http://localhost/Social_Network_Twitter/ajax/follow.php', {unfollow:FollowID,profile:profile}, function(data){
		...
		{
			$.post('http://localhost/Social_Network_Twitter/ajax/follow.php', {follow:FollowID,profile:profile}, function(data){
				data = JSON.parse(data);
