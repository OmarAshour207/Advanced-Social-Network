<?php
	...
	if(isset($_POST['screenName']))
	{
		...
		{
			$error = "Name Fiels can't be blink!";
		}
	}
...
<html>
<head>
	<title><?php echo $profileData->screenName.'(@'.$profileData->user_name.') edit page'; ?></title>
	<meta charset="UTF-8" />
...
<div class="profile-nav">
	<div class="profile-navigation">
		...
		<div class="edit-button">
			<span>
				<button class="f-btn" type="button" onclick="window.location.href='<?php echo $user->user_name; ?>'" value="Cancel">Cancel</button>
			</span>
			<span>
